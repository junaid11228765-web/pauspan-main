...
// ==========================================
// CLIENT ARCHITECTURE GRAPH NAVIGATION CONFIGS
// ==========================================
...
// ==========================================
// MAIN APP DIRECTORY GLOBAL NAVIGATION COMPONENT
// ==========================================
                    ...
                    >
                      <div className="flex items-center gap-2 overflow-x-auto w-full">
                        <div className="flex items-center gap-2 flex-shrink-0">
                          {NAV_ITEMS_CONFIG.map(({ title, href }, index) => {
                            ...
                            return (
                              <motion.a
                                ...
                                className={`font-bold relative px-2 text-[10px] py-1 transition-colors duration-200 rounded-full cursor-pointer whitespace-nowrap flex-shrink-0 ${isActive
              ...
              {!expanded ? (
                ...
                >
                  <div className="flex flex-row gap-2">
                    {NAV_ITEMS_CONFIG.map(({ title, href }) => {
                      const isActive = isActiveRoute(href);
                      return (
                        <motion.a
                          key={title}
                          href={href}
                          onClick={() => handleNavClick(href)}
                          className={`font-bold relative px-4 text-sm py-2 transition-colors duration-200 rounded-full whitespace-nowrap ${isActive
                            ? "bg-accent text-obsidian"
                            : "text-text-dim hover:text-text hover:bg-accent/20"
                            }`}
