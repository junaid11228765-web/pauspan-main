...
const services = [
  "Strategy Consulting", "Brand Development", "Digital Transformation",
  "Growth Marketing", "Product Design", "Operations & Scale", "Other",
];
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="contact-content max-w-2xl">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="font-display font-semibold text-2xl text-text mb-2">Get in Touch</h2>
              ...
              <div className="glass-card rounded-xl p-6">
                <h3 className="font-display font-semibold text-text mb-3">Office Hours</h3>
                <div className="space-y-2 text-sm text-text-dim">
                  <div className="flex justify-between">
                    <span>Monday – Friday</span>
                    <span className="text-text">9am – 6pm EST</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Saturday</span>
                    <span className="text-text">10am – 2pm EST</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Sunday</span>
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                <div className="glass-card rounded-2xl p-16 text-center">
                  ...
                  <h3 className="font-display font-bold text-3xl text-text mb-4">Message Received!</h3>
                ...
                <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-subtle border border-glass-border rounded-xl px-4 py-3 text-text placeholder-muted text-sm focus:outline-none focus:border-accent/40 transition-colors"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    <label className="block text-sm text-text-dim mb-2">Company</label>
                    <input
                      type="text"
                      value={form.company}
                  ...
                  <div>
                    <label className="block text-sm text-text-dim mb-2">Service Interested In</label>
                    <select
                      value={form.service}
                      onChange={(e) => setForm({ ...form, service: e.target.value })}
                      className="w-full bg-subtle border border-glass-border rounded-xl px-4 py-3 text-text text-sm focus:outline-none focus:border-accent/40 transition-colors appearance-none"
                    >
                  ...
                  <div>
                    <label className="block text-sm text-text-dim mb-2">Tell Us About Your Project *</label>
                    <textarea
                      required rows={5}
                      value={form.message}
                      onChange={(e) => setForm({ ...form, message: e.target.value })}
                      placeholder="Describe your project, goals, timeline, and any other details..."
                      className="w-full bg-subtle border border-glass-border rounded-xl px-4 py-3 text-text placeholder-muted text-sm focus:outline-none focus:border-accent/40 transition-colors resize-none"
                    />
                  </div>
